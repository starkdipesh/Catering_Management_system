        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold text-secondary-900">Create Subscription Plan</h1>
                <p className="mt-1 text-sm text-secondary-500">Add a new subscription plan for tenants</p>
              </div>
            </div>
          </div>
        </div>
